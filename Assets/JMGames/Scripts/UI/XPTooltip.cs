...
{
    public class XPTooltip : UIBehaviour, IEventSystemHandler, IPointerEnterHandler, IPointerExitHandler
    {
        [SerializeField] private GameObject m_TooltipObject;
        [SerializeField] private UIProgressBar m_ProgressBar;
        [SerializeField] private Text m_PercentText, m_xpText;
        ...
        private void OnProgressChange(float value)
        {
            ...
            m_xpText.text = MainPlayerController.Instance.Experience.CurrentExperience + " / " + MainPlayerController.Instance.Experience.RequiredExpToLevelUp;
        }
